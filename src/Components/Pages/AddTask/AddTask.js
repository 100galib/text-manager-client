...
const AddTask = () => {
    ...
    const fileUpload = event => {
        ...
        const textArea = form.taskdescription.value;
        const file = form.file.value;
        console.log(textArea, file)
    }

    return (
        <div>
        <form onSubmit={fileUpload} className='px-3 lg:w-3/5 mx-auto mt-24'>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                    ...
                    <div className="flex pl-0 space-x-1 sm:pl-2">
                        ...
                        <input name='file' className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="multiple_files" type="file" multiple></input>                       
                    </div>
                </div>
            </div>
        </form>
